jQuery(function ($) {
    ...
    var Formoid = (function () {
        ...
        var API_URL = ('https:' == location.protocol ? 'https:' : 'http:') + '//www.alectrica.cl/api/v1/electrico/presupuestos/create_from_landing_page';
        ...
        Form.prototype.send = function (data, beforeStart) {
            ...
            $ajax(API_URL, {
                type: 'POST',
		  data: { email: this.__email__, title: this.__title__, data: this.__data__ }
//                data: JSON.stringify({
