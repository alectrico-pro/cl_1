jQuery(function ($) {
    ...
    var Formoid = (function () {
        ...
        var API_URL = ('https:' == location.protocol ? 'https:' : 'http:') + '//www.alectrica.cl/api/v1/electrico/presupuestos/create_from_landing_page.json';
        ...
        Form.prototype.send = function (data, beforeStart) {
            ...
            $ajax(API_URL, {
                type: 'POST',
		  data: {data: (arguments.length ? data : this.__data__)  }
//                data: JSON.stringify({
